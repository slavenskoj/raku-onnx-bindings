...
# Get more function indices
%indices<SessionGetInputName> = 36;
%indices<SessionGetOutputName> = 37;
%indices<SessionGetInputCount> = 30;
%indices<SessionGetOutputCount> = 31;
%indices<GetAllocatorWithDefaultOptions> = 78;
%indices<CreateCpuMemoryInfo> = 64;
%indices<CreateTensorWithDataAsOrtValue> = 44;
%indices<GetTensorMutableData> = 46;
%indices<Run> = 9;
